...
function ExtendAirborneAircraft(name, rotation_speed, braking_power, max_health, weight, hasTakeoffSprites)
    ...
    plane.friction = 0.0001 --Less friction so they glide and don't constantly need one to hold the accelerator
    data:extend{plane}
end
...
--Flying fortress
ExtendAirborneAircraft("flying-fortress", 0.008, "2420kW", 2000, 7500, true)
